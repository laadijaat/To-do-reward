...
contract Todos is Ownable, TaskFactory{
  ...
  /// @param _detailedDescription Detailed task description
  /// @param _dueDate Task due date
  function add(string memory _description, string memory _detailedDescription, uint _dueDate) public {
    _add(_description, _detailedDescription, _dueDate);
  }
